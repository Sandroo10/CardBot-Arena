...
export const detailShell = cva("min-h-screen py-8 sm:py-12")

export const detailContent = cva("space-y-6 sm:space-y-8")
...
export const heroPanel = cva(
  "mx-auto grid max-w-6xl gap-6 overflow-hidden rounded-[1.25rem] border border-white/8 bg-background/76 p-4 shadow-[0_16px_36px_rgba(0,0,0,0.2)] sm:rounded-[1.5rem] sm:p-5 lg:grid-cols-[1.05fr_0.95fr] lg:gap-7 lg:p-7"
)
...
export const heroAvatar = cva(
  "grid size-20 shrink-0 place-items-center rounded-[1.35rem] border text-2xl font-black shadow-[0_16px_34px_rgba(0,0,0,0.22)] sm:size-24 sm:text-3xl",
  {
    variants: {
      game: {
...
export const detailTitle = cva("text-3xl font-black leading-tight text-foreground sm:text-5xl")
...
export const actionRow = cva("flex flex-col gap-3 sm:flex-row sm:flex-wrap")
...
export const tablePanel = cva(
  "rounded-[1.25rem] bg-[radial-gradient(circle_at_50%_18%,rgba(20,184,166,0.18),rgba(15,23,42,0.72)_58%)] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.1),0_16px_34px_rgba(6,182,212,0.08)] sm:rounded-[1.35rem] sm:p-5"
)

export const tableHeader = cva("flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4")
...
export const cardFan = cva("mt-7 flex min-h-36 items-center justify-center gap-1 sm:mt-8 sm:min-h-44 sm:gap-5")

export const previewCard = cva(
  "grid h-28 w-16 content-between rounded-xl border bg-zinc-100 p-2.5 text-slate-950 shadow-[0_16px_28px_rgba(0,0,0,0.22)] sm:h-36 sm:w-24 sm:rounded-2xl sm:p-4",
  {
    variants: {
      accent: {
...
export const cardRank = cva("text-xl font-black sm:text-3xl")

export const cardLabel = cva("text-center text-[0.55rem] font-black uppercase tracking-[0.1em] sm:text-xs sm:tracking-[0.22em]")
...
export const statGrid = cva("mt-5 grid gap-3 sm:grid-cols-2")
